...
class MobileValidationSMSCodeViewModel extends FormViewModel {
  ...
  final MobileValidationService _mobileValidationService =
  ...
  Future<void> resendSmsCode(String icc, String mobileNumber) async {
    await runBusyFuture(_mobileValidationService.sendMobileValidationCode(
        icc,
        mobileNumber,
